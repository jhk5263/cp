...
function completeLoading(){if(document.readyState=="complete"){var loadingMask=document.getElementById('loadingDiv');loadingMask.parentNode.removeChild(loadingMask)}}
$(function(){$("#qieh").click(function(){if($("#qieh").is(":checked")){$("#app").css("display","none");$("#app1").css("display","block")}else{$("#app1").css("display","none");$("#app").css("display","block")}})})
